...
export default function ProductsPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex flex-wrap gap-2 w-full md:w-auto">
                    ...
                    <Button
                        ...
                        size="sm"
                        className={cn(filter === 'low' && "bg-amber-500 hover:bg-amber-600")}
                    >
                        نواقص
                    </Button>
                    <Button
                        ...
                        size="sm"
                        className={cn(filter === 'out' && "bg-destructive hover:bg-destructive/90")}
                    >
                        نواقص حادة
                    </Button>
                    {canManage && (
            ...
            {/* Search Bar */}
            <div className="flex gap-2 md:gap-4 items-center bg-card p-3 md:p-4 rounded-lg border shadow-sm">
                            ...
                            filteredProducts.map((product) => {
                                ...
                                return (
                                    <TableRow key={product._id} className={cn(
                                        ...
                                        isLow && 'bg-amber-50 dark:bg-amber-950/20'
                                    )}>
